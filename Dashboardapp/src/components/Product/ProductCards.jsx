...
function ProductCards({ title, key, price, category, image }) {
  return (
    <>
      <div className="p-8 bg-slate-50 shadow-md transition duration-150 ease-in-out hover:shadow-2xl">
        ...
        <div className="flex justify-around mt-2">
          ...
          <button className="text-red-600 p-2 font-semibold flex items-center transition-all ease-in-out duration-150 border border-gray-300 hover:shadow-lg hover:font-bold rounded-lg">
            <DeleteIcon />
            Delete
          </button>
        </div>
